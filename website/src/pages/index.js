...
const Home = () => (
    <div className={homeStyles.wrapper}>
        ...
        <br/><br/>
        Currently, I am working out of my home city of <ImportantText text='Stockholm, Sweden'/>, helping <ImportantText text='Topgolf'/> revolutionize the game of golf. If you want to know more about what I have done, check out my <HighlightText text='CV'/> or my <HighlightText text='projects'/>, send me an <HighlightText text='email'/> or check out my other <HighlightText text='pages'/>.
        <br/><br/>
        Take care!
    </div>
)
