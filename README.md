...
This is a personal website used to detail information about myself. It contains my CV, as well as information about projects I've been working on.

## Gatsby

This website was created using Gatsby. Below you will find information (_slightly_ modified from the official Gatsby README) on how to use this framework.

1.  **Start developing.**

    Navigate into the website’s directory and start it up.
